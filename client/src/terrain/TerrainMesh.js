...
const TERRAIN_WORLD = 12;         // plane width in scene units; bbox shrunk slightly + east trimmed
const TERRAIN_HEIGHT = 1.3;       // peak displacement (scaled with TERRAIN_WORLD)
